...
class FourteenthViewController: UIViewController {
    ...
    func setupRichContent() {
        ...
        ・蛇形の井
        約800年ほど前この地で将軍の側近として絶大な力を誇った比比企一族は、ライバルの北氏と権力争いをしていました。しかし比企一族はこの戦いに敗れ、この地で滅ぼされました。比企一族の女性の若狭局が一族が攻められた際、家宝を抱えてこの井戸に身を投げ、自害したと伝えられています。若狭局の死後、彼女は大蛇に化身して、井戸の底で家宝を守り続けているという伝説が生まれています。ぜひ見てみてください。
